 ...
 <body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
  ...
  <main class="bg-blue-600 rounded-lg p-8 mt-8 w-full max-w-md">
   ...
   <form class="space-y-4">
    <input class="w-full p-3 rounded-full bg-blue-200 text-gray-700 focus:outline-none" placeholder="Email" type="email"/>
    <input class="w-full p-3 rounded-full bg-blue-200 text-gray-700 focus:outline-none" placeholder="Password" type="password"/>
    <div class="text-right">
     <a class="text-white text-sm" href="#">
      Lupa password?
     </a>
    </div>
    <button class="w-full p-3 rounded-full bg-blue-200 text-gray-700 font-bold" type="submit">
     LOGIN
    </button>
   </form>
  </main>
