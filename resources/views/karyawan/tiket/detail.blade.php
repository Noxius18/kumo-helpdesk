    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <p class="mt-1 text-gray-800">
                <span class="px-2 py-1 rounded text-sm font-medium {{ $tiket->status == 'Open' ? 'bg-green-100 text-green-800' : ($tiket->status == 'In_Progress' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800') }}">
                    {{ $tiket->status }}
                </span>
            </p>
        </div>
